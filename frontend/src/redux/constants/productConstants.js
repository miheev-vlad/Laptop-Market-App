...
export const GET_PAGIN_PRODUCTS_REQUEST = "GET_PAGIN_PRODUCTS_REQUEST";
export const GET_PAGIN_PRODUCTS_SUCCESS = "GET_PAGIN_PRODUCTS_SUCCESS";
export const GET_PAGIN_PRODUCTS_FAIL = "GET_PAGIN_PRODUCTS_FAIL";
